...
#define c_0 349  // 344  349 speed of sound
...
int ListenerCompensationCAP::calcDelayComp( visr::efl::BasicVector<Afloat> & delayComp )
{
    ...
    for (std::size_t i = 0; i < m_array.getNumRegularSpeakers(); i++) {
...
//?           delayComp[i] = ( max_rad - delayComp[i] ) /c_0;  c_0?
    }
//    printf("%f  %f  \n", delayComp[0], delayComp[1]);
    return 0;
}
