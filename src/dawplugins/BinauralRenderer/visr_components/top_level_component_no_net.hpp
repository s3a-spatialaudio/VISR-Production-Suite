...
#ifndef BINAURAL_RENDERER_TOP_LEVEL_COMPONENT_NONET_HPP_INCLUDED
#define BINAURAL_RENDERER_TOP_LEVEL_COMPONENT_NONET_HPP_INCLUDED
 ...
 */
class TopLevelComponentNoNet: public visr::CompositeComponent
{
public:
    
    explicit TopLevelComponentNoNet( visr::SignalFlowContext const & context,
                                char const * name,
