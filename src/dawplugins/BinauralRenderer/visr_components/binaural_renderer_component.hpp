...
#ifndef BINAURAL_RENDERER_COMPONENT_HPP_INCLUDED
#define BINAURAL_RENDERER_COMPONENT_HPP_INCLUDED
 ...
 */
class BinauralRendererComponent: public visr::CompositeComponent
{
public:
    
    explicit BinauralRendererComponent( visr::SignalFlowContext const & context,
                                char const * name,
...
#endif // BINAURAL_RENDERER_COMPONENT_HPP_INCLUDED
